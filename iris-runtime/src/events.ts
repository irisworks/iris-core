...
import { existsSync, type FSWatcher, mkdirSync, readFileSync, readdirSync, statSync, unlinkSync, watch } from "fs";
...
export class EventsWatcher {
	...
	private parseEvent(content: string, filename: string): IrisEvent | null {
